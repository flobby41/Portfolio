...
const skillsData = [
  {
    ...
    description:
      "Custom e-commerce solutions built with modern tech stack including Next.js, Node.js, and various APIs.",
    icon: "💼",
    link: "/work",
  ...
  },
  {
    title: "Experiments",
    description:
      "Interactive prototypes and technical experiments showcasing creative coding and problem-solving.",
    icon: "🔬",
    link: "/experiments",
  ...
  },
  {
    title: "About Me",
    description:
      "Programmer, designer, and singer passionate about creating engaging digital experiences.",
    icon: "👨‍💻",
    link: "/about",
          ...
          <div className="max-w-7xl mx-auto px-0">
            ...
            >
              {skillsData.map((skill, index) => (
                ...
                >
                  <div
                    className={`flex-1 ${index % 2 === 0 ? "order-1" : "order-2"} text-center md:text-left mx-auto`}
                  >
                    <h2 className="skills_title text-4xl font-bold mb-6 text-center md:text-left">
                      {skill.title}
                      <span className="text-[#73BBC5]">.</span>
                    </h2>
                    <p className="skills text-base mb-8 system-font text-center md:text-left">
                      {skill.description}
                    </p>

                    <motion.a href={skill.link} className="btn mx-auto md:mx-0">
                      <span className="btn__label">Explore {skill.title}</span>
                      <motion.span
