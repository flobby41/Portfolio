  ...
  return (
    <div ref={ref} className="relative w-full overflow-hidden my-16 ">
      ...
      >
        <div className="relative">
          <motion.h1
            ...
            animate={
              loadingComplete ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
            }
            transition={{
              duration: 0.2,
              delay: 0.5,
      ...
      <motion.p
        ...
        animate={
          loadingComplete ? { opacity: 1, y: 0 } : { opacity: 0, x: -20 }
        }
        transition={{ delay: 0.5, duration: 0.8 }}
      >
        When I first started coding, I quickly realized that the best way to
        learn was by building. So, I created a{" "}
        <Link href="https://flobby41.github.io/sandbox/">sandbox</Link> — a
        space where I could experiment with new frameworks, test API
        integrations, and push my skills beyond their comfort zone. It’s a
        playground for concepts that might never see production but always teach
