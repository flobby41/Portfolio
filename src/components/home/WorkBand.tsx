...
const WorkBand = () => {
  ...
  return (
    <div ref={ref} className="relative w-full overflow-hidden my-16 ">
      ...
      {/* Nouveau contenu */}
      <motion.p
        className="font-bitter text-2xl text-[#0f1b61] mt-10"
      ...
      >
        I architect and deliver headless digital storefronts with Next.js,
        handling everything from UX design to cloud deployment.
        {/* Bouton très stylé */}
