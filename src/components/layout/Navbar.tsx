    ...
    <nav className="fixed top-0 left-0 right-0 z-40">
      ...
      <div className="mainnav  w-full py-4 px-6">
        <div className="relative w-full h-32">
          ...
          <div className="flex menu-link absolute top-[35px] left-[150px]">
            ...
            >
              {isMenuOpen ? (
                <div className="flex">
                  <span className="transition-transform duration-150 group-hover:-translate-x-[5px]">
                    C
                  </span>
        ...
        <div className="flex items-center gap-6 z-50">
          ...
          >
            <div
              className="shade hidden sm:block"
              data-drift="-4 -6"
              data-drift-center="y"
              style={{
                transform: "translateY(-50%) translate(-3.94702px, 2.41256px)",
              }}
            >
            ...
            <div className="flex">
              ...
              <span className="transition-transform duration-150 group-hover:translate-x-[7px]">
                E
              </span>
            </div>
          </Link>
            ...
            >
              <div className="main-menu__flyout">
                <div className="main-menu__inr p-8 grid grid-rows-[50px_80px_20px] gap-6 min-h-screen">
                  ...
                  <motion.ul
                    className="main-menu__links hover pt-0 "
                    variants={{
                      animate: {
                        transition: {
                          delayChildren: 0.7,
                  ...
                  >
                    {[
                      ...
                      },
                      {
                        href: "/work",
                        title: "Work",
                        desc: "My approach to development.",
                      },
                      {
                        href: "/about",
                        title: "About",
                        desc: "A little about me and my background.",
                      },
                      {
                        href: "/experiments",
                        title: "Experiments",
                        desc: "My latest experiments in tech and language.",
                      },
                    ].map((link, index) => (
                      <motion.li
                        key={link.href}
