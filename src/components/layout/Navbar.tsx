              ...
              <div className="main-menu__flyout">
                <div className="main-menu__inr p-8">
                  ...
                  <motion.div
                    ...
                    className="relative h-[3px] bg-[#7f00e0] mt-8 mb-8"
                  />
                  ...
                  >
                    {socialIcons.map((social) => (
                      <motion.a
                        key={social.icon}
                        href={social.href}
                        className="text-[#342c6e] hover:text-[#f5f5f5] transition-colors"
                        variants={itemVariants}
                      >
                        ...
                        {social.icon === 'mail' && (
                          <svg width="24" height="24" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
                            <g fill="currentColor" transform="translate(11.000000, 18.000000)">
