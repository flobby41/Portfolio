                    ...
                    >
                      {socialIcons.map((social) => (
                        <motion.a
                          key={social.icon}
                          href={social.href}
                          className="group text-[#342c6e]"
                          variants={socialIconsVariants}
                        >
                          <span className="sr-only">{social.label}</span>
                          {social.icon === 'linkedIn' && (
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 48 48">
                              <path className="CACA" d="M42,37c0,2.762-2.238,5-5,5H11c-2.761,0-5-2.238-5-5V11c0-2.762,2.239-5,5-5h26c2.762,0,5,2.238,5,5V37z"/>
